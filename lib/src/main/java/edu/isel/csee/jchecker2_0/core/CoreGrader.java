package edu.isel.csee.jchecker2_0.core;
...
import edu.isel.csee.jchecker2_0.core.stage.*;
import edu.isel.csee.jchecker2_0.score.*;
import edu.isel.csee.jchecker2_0.statics.*;
...
public class CoreGrader {
	...
	public String start(String path, String policy) {
		...
		srcPathList = source.getAllFilePaths(workpath);
